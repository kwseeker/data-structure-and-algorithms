...
public class EdgeWeightedDirectedCycle {
     ...
     */
    public EdgeWeightedDirectedCycle(AdjacencyListWeightedDigraph G) {
    ...
    private void dfs(AdjacencyListWeightedDigraph G, int v) {
        onStack[v] = true;
        marked[v] = true;
    ...
    public static void main(String[] args) {
        ...
        AdjacencyListWeightedDigraph G = new AdjacencyListWeightedDigraph(V);
