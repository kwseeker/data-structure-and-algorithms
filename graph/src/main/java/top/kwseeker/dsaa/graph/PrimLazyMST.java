...
public class PrimLazyMST {
     ...
     */
    public PrimLazyMST(AdjacencyListWeightedGraph G) {
        mst = new Queue<Edge>();
        pq = new MinPQ<Edge>();
    ...
    private boolean check(AdjacencyListWeightedGraph G) {
    ...
    /**
     * Unit tests the {@code PrimLazyMST} data type.
     *
