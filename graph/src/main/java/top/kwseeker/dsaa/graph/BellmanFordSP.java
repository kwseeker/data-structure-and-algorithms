...
public class BellmanFordSP {
     ...
     */
    public BellmanFordSP(AdjacencyListWeightedDigraph G, int s) {
    ...
    private void relax(AdjacencyListWeightedDigraph G, int v) {
    ...
    private void findNegativeCycle() {
        int V = edgeTo.length;
        AdjacencyListWeightedDigraph spt = new AdjacencyListWeightedDigraph(V);
        for (int v = 0; v < V; v++)
            if (edgeTo[v] != null)
    ...
    private boolean check(AdjacencyListWeightedDigraph G, int s) {
